...
leaflet(data=map, options = leafletOptions(backgroun="#FFF")) %>%
  ...
  addLayersControl(
    baseGroups = c("CCG overall score","% of referrals closed</br>without treatment","Average CAMHS waiting time (days)","% of children referred to CAMHS","CAMHS spend per child","% of CCG budget spent on CAMHS"),
