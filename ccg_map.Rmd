...
for(i in c("perc_budget","spend_YP","perc_access","avg_wait","perc_closed","overall_score")){
  ...
  overall_sc<-overall_sc %>%
    mutate(!!vNm:=factor(ifelse(spend_YP< 30, "&#16310 to &#16330", 
                            ifelse(spend_YP< 50,"&#16330 to 50", 
                              ifelse(spend_YP< 70,"&#16350 to &#16370",
                                ifelse(spend_YP< 90,"&#16370 to &#16390","&#16390+")))),
      levels=c("&#16310 to &#16330","&#16330 to 50","&#16350 to &#16370","&#16370 to &#16390","&#16390+"))) 
...
outcomes<-data.frame(var=c("perc_budget","spend_YP","perc_access","avg_wait","perc_closed","overall_score"),
                     lb=c("% of CCG budget spent on CAMHS","Spend per child (&#163) on CAMHS","% of children referred to CAMHS",
...
leaflet(data=map, options = leafletOptions(backgroun="#FFF")) %>%
  ...
  addLegend("topleft", pal = pal_bin, values=c("&#16310 to &#16330","&#16330 to 50","&#16350 to &#16370","&#16370 to &#16390","&#16390+"),
            title = "Title",
            na.label = "Missing/excluded",
            opacity = 0.7
  )
