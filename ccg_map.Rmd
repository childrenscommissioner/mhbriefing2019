...
for(i in c("perc_budget","spend_YP","perc_access","avg_wait","perc_closed","overall_score")){
  ...
  overall_sc<-overall_sc %>%
    mutate(!!vNm:=factor(ifelse(spend_YP< 30, "\\xA310 to \\xA330", 
                            ifelse(spend_YP< 50,"\\xA330 to \\xA350", 
                              ifelse(spend_YP< 70,"\\xA350 to \\xA370",
                                ifelse(spend_YP< 90,"\\xA370 to \\xA390","\\xA390+")))),
      levels=c("\\xA310 to \\xA330","\\xA330 to \\xA350","\\xA350 to \\xA370","\\xA370 to \\xA390","\\xA390+"))) 
...
leaflet(data=map, options = leafletOptions(backgroun="#FFF")) %>%
  ...
  addLegend("topleft", pal = pal_bin, values=c("\\xA310 to \\xA330","\\xA330 to \\xA350","\\xA350 to \\xA370","\\xA370 to \\xA390","\\xA390+"),
            title = "Title",
            na.label = "Missing/excluded",
            opacity = 0.7
  )
