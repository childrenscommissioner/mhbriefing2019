...
overall_sc<-overall_sc %>%
    mutate(spend_YP_fill=factor(knitr::asis_output(ifelse(spend_YP< 30, "&pound;10 to &pound;30", 
                            ifelse(spend_YP< 50,"&pound;30 to &pound;50", 
                              ifelse(spend_YP< 70,"&pound;50 to &pound;70",
                                ifelse(spend_YP< 90,"&pound;70 to &pound;90","&pound;90+"))))),
      levels=knitr::asis_output(c("&pound;10 to &pound;30","&pound;30 to &pound;50","&pound;50 to &pound;70","&pound;70 to &pound;90","&pound;90+"))))
...
leaflet(data=map, options = leafletOptions(backgroun="#FFF")) %>%
  ...
  addLegend("topleft", pal = pal_bin, values=knitr::asis_output(c("&pound;10 to &pound;30","&pound;30 to &pound;50","&pound;50 to &pound;70","&pound;70 to &pound;90","&pound;90+")),
            title = "Title",
            na.label = "Missing/excluded",
            opacity = 0.7
  )
